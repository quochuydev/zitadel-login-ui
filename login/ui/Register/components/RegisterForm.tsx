...
const RegisterForm: React.FC<RegisterFormProps> = (props) => {
  ...
  const schema = object({
    ...
    .refine((data) => calculateByteSize(data.password) <= maxByteSize, {
      message: t('auth:ERROR_PASSWORD_LIMIT_SIZE', { maxByteSize }),
      path: ['password'],
    })
    .refine((data) => data.password === data.confirmPassword, {
      message: t('auth:PASSWORD_CONFIRM_MISMATCH'),
  ...
  return (
    <form onSubmit={handleSubmit(handleRegisterForm)} noValidate>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <Input
              ...
              placeholder={t('auth:GIVEN_NAME_PLACEHOLDER')}
              disabled={loading}
              {...register('givenName')}
            />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={hidePwd ? t('auth:SHOW_PASSWORD') : t('auth:HIDE_PASSWORD')}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={
                hideConfirmPwd ? t('auth:SHOW_PASSWORD') : t('auth:HIDE_PASSWORD')
              }
      ...
      >
        {loading || isSubmitting ? t('LOADING') : t('auth:REGISTER')}
      </button>
    </form>
  );
};
