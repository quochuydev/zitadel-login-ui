    ...
    return (
      <div ref={containerRef} className="relative">
        <button
          ...
          className="flex h-8 items-center gap-1 rounded-full border border-gray-200 bg-white px-2 text-base transition-colors hover:bg-gray-50"
        >
        ...
        {open && menu('absolute right-0 top-full z-50 mt-2 rounded-lg')}
      </div>
    );
  }
