  ...
  const processPasskey = async ()=>{
    ...
    if(passkeyId && publicKeyCredentialCreationOptions){
      try {
        ...
        console.log('publicKeyCredentialCreationOptions', publicKeyCredentialCreationOptions.publicKey);
        ...
        <div className="my-4 ">
          ...
          <button
              onClick={async (e) => {
                ...
                const publicKeyCredentialRequestOptions = session.challenges.webAuthN.publicKeyCredentialRequestOptions
                ...
                publicKeyCredentialRequestOptions.publicKey.allowCredentials.map((listItem: any) => {
