...
export default function PasskeysManager(props: {
  ...
  const addPasskey = async () => {
    if (!passkeyId || !publicKeyCredentialCreationOptions) {
      toast.error('Unable to start passkey registration');
      return;
    }
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-[24px] font-semibold text-gray-900">Passkeys</h2>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Your browser will ask you to use your device&apos;s fingerprint,
                face, screen lock, or a security key to create a passkey.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button
              ...
              >
                ...
                <span className="flex min-w-0 flex-1 flex-col">
                  ...
                  <span className="text-xs text-gray-500">
                    {passkey.state === 'MFA_STATE_READY' ? 'Ready' : 'Pending'}
                  </span>
                </span>
                <Button
                  variant="ghost"
